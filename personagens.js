    ...
    try{
        ...
        responseJson.results.forEach((characters) =>{
            ...
            cards.onclick = () =>{
                ...
                height.innerText = `Altura: ${convertHeight(characters.height)}`
                ...
                eyeColors.innerText = `Cor dos olhos: ${convertEyeColors(characters.eye_color)}`

                const birth = document.createElement('span')
                birth.className = 'content-details'
                birth.innerText = `Nascimento: ${convertBirth(characters.birth_year)}`
